...
public interface IConnectorFactory {
    ...
    /**
     * Create a connector listening on the supplied host and port
     * @param selectorRegistrarBalancer
     * @param taskScheduler
     * @param listenAddress
     * @return
     * @throws IOException
     */
    IConnector create(ISelectorRegistrarBalancer selectorRegistrarBalancer,
